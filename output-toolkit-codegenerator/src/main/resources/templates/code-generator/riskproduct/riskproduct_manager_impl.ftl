...
@Slf4j
@Component
public class ${classInfo.className}${managerSuffix}Impl implements ${classInfo.className}${managerSuffix} {
    ...
    */
    ...
    public Boolean insert(${classInfo.className}VO ${classInfo.className?uncap_first}) {
        log.info("${classInfo.className}${managerSuffix}Impl.insert方法开始，参数：{}", JSON.toJSONString(${classInfo.className?uncap_first}));
        //参数校验
        ...
        int result = ${classInfo.className?uncap_first}${mapperSuffix}.insert(${classInfo.className?uncap_first});
        log.info("${classInfo.className}${managerSuffix}Impl.insert方法结束");
        return result > 0;
    }
    ...
    */
    ...
    public Boolean delete(${classInfo.className}VO ${classInfo.className?uncap_first}) {
        log.info("${classInfo.className}${managerSuffix}Impl.delete方法开始，参数：{}", JSON.toJSONString(${classInfo.className?uncap_first}));
        //参数校验
        ValidateUtil.paramValidate(Objects.isNull(${classInfo.className?uncap_first}),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "参数不能为空！");
        //ValidateUtil.validateString(${classInfo.className?uncap_first}.getId(),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "string类型的id不能为空！");
        //ValidateUtil.paramValidate(Objects.isNull(${classInfo.className?uncap_first}.getId()),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "long类型的id不能为空！");
        ...
        log.info("${classInfo.className}${managerSuffix}Impl.delete方法结束");
        return result > 0;
    }
    ...
    */
    ...
    public Boolean update(${classInfo.className}VO ${classInfo.className?uncap_first}) {
        log.info("${classInfo.className}${managerSuffix}Impl.update方法开始，参数：{}",  JSON.toJSONString(${classInfo.className?uncap_first}));
        //参数校验
        ValidateUtil.paramValidate(Objects.isNull(${classInfo.className?uncap_first}),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "参数不能为空！");
        //ValidateUtil.validateString(${classInfo.className?uncap_first}.getId(),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "string类型的id不能为空！");
        //ValidateUtil.paramValidate(Objects.isNull(${classInfo.className?uncap_first}.getId()),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "long类型的id不能为空！");
        ...
        log.info("${classInfo.className}${managerSuffix}Impl.update方法结束");
        return result > 0;
    ...
    */
    ...
    public ${classInfo.className}VO queryById(${classInfo.className}VO ${classInfo.className?uncap_first}) {
        log.info("${classInfo.className}${managerSuffix}Impl.queryById方法开始，参数：{}", JSON.toJSONString(${classInfo.className?uncap_first}));
        //参数校验
        ValidateUtil.paramValidate(Objects.isNull(${classInfo.className?uncap_first}),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "参数不能为空！");
        //ValidateUtil.validateString(${classInfo.className?uncap_first}.getId(),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "string类型的id不能为空！");
        //ValidateUtil.paramValidate(Objects.isNull(${classInfo.className?uncap_first}.getId()),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "long类型的id不能为空！");
        ...
        log.info("${classInfo.className}${managerSuffix}Impl.queryById方法结束");
    ...
    */
    @Override
    public List<${classInfo.className}VO> pageList(${classInfo.className}VO ${classInfo.className?uncap_first}) {
        log.info("${classInfo.className}${managerSuffix}Impl.pageList方法开始，参数：{}", JSON.toJSONString(${classInfo.className?uncap_first}));
        //参数校验
        //ValidateUtil.paramValidate(Objects.isNull(${classInfo.className?uncap_first}),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "参数不能为空！");
        //ValidateUtil.validateString(${classInfo.className?uncap_first}.getId(),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "string类型的id不能为空！");
        //ValidateUtil.paramValidate(Objects.isNull(${classInfo.className?uncap_first}.getId()),BizErrorCode.BLANK_IS_ILLEGAL_PARAM, "long类型的id不能为空！");
        ...
        log.info("${classInfo.className}${managerSuffix}Impl.queryById方法结束,list.size={}", voList.size());
        return voList;
    }
}